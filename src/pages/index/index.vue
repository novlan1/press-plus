    ...
    >
      <div class="index-page__header">
        ...
        <img
          ...
          src="https://mike-1255355338.cos.ap-guangzhou.myqcloud.com/article/2023/11/own_mike_c13ef4021db3bd9908.png"
          mode="aspectFit"
...
export default {
  i18n: {
    'zh-CN': {
      share: '分享',
      name: '全端兼容 高性能',
      detail: 'Press Plus 是一套易用的、灵活的、基于 uni-app 的组件库',
      otherAbility: '其他功能',
      toggleLanguage: '切换语言',
    ...
    'en-US': {
      ...
      detail: 'Press Plus is an easy-to-use, uni-app-based component library',
