...
<script>
import { imagePreview } from 'press-ui/press-image-preview';
import Popover from 'press-ui/press-popover-plus/press-popover-plus.vue';
// #ifdef H5
import PressQRCodeWeb from 'vue-qrcode';
import PressBarcodeWeb from 'vue-barcode';
// #endif
// #ifndef H5
import PressQRCodeMp from 'press-ui/press-q-r-code/press-q-r-code.vue';
import PressBarcodeMP from 'press-ui/press-barcode/press-barcode';
// #endif
